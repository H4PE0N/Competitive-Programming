...
gcc -o testing-bootup-program-7 testing-bootup-program-7.c \
...
../../Library-Functions-Folder/Library-Functions-Folder-2/library-functions-program-4-3.c \
...
../../Functions-Testing-Folder/Functions-Testing-Folder-7/functions-testing-program-7-1.c \
../../Functions-Testing-Folder/Functions-Testing-Folder-7/functions-testing-program-7-2.c -lm

After you have compiled the  program,  type  the  following  
command to run the executable file, that is going to appear  
in the folder:

./testing-bootup-program-7
